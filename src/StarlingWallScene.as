package {
	...
	public class StarlingWallScene extends Sprite {
		...
		public function get wall() : Sprite { return _wall; }
		public function set wall(wall : Sprite) : void { _wall = wall; }

		public static function getInstance():StarlingWallScene { return _instance; }

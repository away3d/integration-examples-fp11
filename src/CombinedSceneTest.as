package 
{
	...
	public class CombinedSceneTest extends Sprite
	{
		...
		private function buildScenes() : void {
			...
			build_Starling_Wall_Scene();					// Background layer
			build_Away3D_Character_Scene();					// Mid layer
			build_Starling_Ball_Impact_Effect_Scene();		// Foreground layer
			
			// Scene 2 : Build our 3D (Rotating cube) and 2D (HUD and scrolling text) scenes for scene 2
			build_Away3D_HUD_Scene();						// Background layer
			build_Starling_HUD_Scene();						// Foreground layer
			_renderScene2 = true;

...
package starling.core {
	...
	public class Starling extends EventDispatcher {
		...
		private function onKey(event : KeyboardEvent) : void {
			...
			makeCurrent();
			mStage.dispatchEvent(new starling.events.KeyboardEvent(event.type, event.charCode, event.keyCode, event.keyLocation, event.ctrlKey, event.altKey, event.shiftKey));
		}
